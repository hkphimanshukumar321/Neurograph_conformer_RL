...
def main():
    ...
    if args.stage == 4:
        ...
        stage3_ckpt = args.pretrained or exp_dir / "best_model.pt"
        ...
        if not stage3_ckpt.exists():
            ...
            logger.info("Note: Full RL training requires multi-task generation decoder with text generation heads.")
            logger.info("Current implementation provides reward computation framework for SCST, MWER, PPO.")
